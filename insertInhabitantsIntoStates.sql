/*Inserts inhabitants of 2013 and 2017 for each state into table (this data is needed for computing the election result and is not included into the csv-files from bundeswahlleiter)*/
