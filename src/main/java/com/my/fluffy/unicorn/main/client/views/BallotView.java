...
public class BallotView extends VerticalPanel  {
    ...
    public void lock() {
        this.clear();
        this.add(new Label("You have entered 10 invalid Tokens successively. " +
                "Please inform any election assistant around you and have them restart the system."));
    }
            ...
            public void onClick(ClickEvent clickEvent) {
                mainService.App.getInstance().checkToken(tokenBox.getValue(), new AsyncCallback<Boolean>() {
                    ...
                    public void onFailure(Throwable throwable) {
                        DialogBox box = new ConfirmDialog("Attention", "Could not check token!" , "OK");
                        box.center();
                        box.show();
